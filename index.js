...
- ✗ "我笑了一下：'你确定要现在提这件事？'"（预知 + 点破 + 占上风，违反 Vol.3.1 / 3.3 / 3.4）
- ✗ "我把杯子放下，看着他没说话。"（零反应形状，违反 Vol.3.2）
- ✗ "他扫了我一眼，嘴角一勾。"（姿态镜像，违反 Vol.3.2）
- ✗ "我靠在椅背上，没什么表情。"（稳如老狗默认形状，违反 Vol.3.5）
- ✗ "我知道他心里在想什么，所以什么都没说。"（全知内心，违反 Vol.3.1 / 3.3）
- ✗ "我把手机推过去，他脸色一下就变了。"（替对方写反应，违反 Vol.3.4）
- ✗ "我按计划收回视线。"（掌控全局感，违反 Vol.3.6）
- ✗ "A. 我以 Ne 为主导发散了一下……"（出现 MBTI 字样，违反 Vol.5）

## Vol.8 终检（每条选项逐一过一遍，13 行都要有）
### 1. 接续：这条选项与上一段末句是同一口气吗？___
### 2. 信息源：这条选项里关键信息，说话/行动的人凭什么是知道的？___
### 3. 预知感：有没有"我早就知道/我早料到/果然如此"这类姿态？___
### 4. 零反应：user 面对冲击时的动作是不是只剩"没反应"？有没有写出一样具体在动的东西？___
### 5. 点破：user 的台词有没有一句替对方下结论？___
### 6. 占上风：选项里有没有替对方写反应（脸色/顿住/沉默/退）？___
### 7. 稳：选项有没有默认写 user"稳如老狗"、游刃有余？___
### 8. 掌控：选项有没有带出"我早就安排好、他不过是棋子、节奏在我手上"这类支配感？___
### 9. 长短：每条的长度是否符合 user 的人设（话痨 / 寡言 / 中性）？___
### 10. 维度：本条对应 Vol.4 的哪一维？有没有两条同维？___
### 11. MBTI 字样：选项正文里有没有漏出"Ne / Fe / Se / Te / Ni / Fi / Si / Ti"或中文维度名？___
### 12. 数量：是不是 4~6 条？编号是否从 A 连续到末尾字母？___
### 13. 收尾：每一条都能让正文模型接得上、又不带全知全能感吗？___
（以上十三行必须逐条填，不许合并、不许省略。任何一条为"是/有"的，先改选项，再继续。）`;
